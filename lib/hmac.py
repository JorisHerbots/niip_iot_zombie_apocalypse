...
# Note JHerbots: This is a crude re-implementation of the original HMAC lib
# Tested and works; not all edgecases were tested
# Original: https://github.com/micropython/micropython-lib/blob/master/hmac/hmac.py
# Re-implementation: https://forum.pycom.io/topic/2180/hmac-on-on-lopy
...
class HMAC:
    ...
    # JHerbots: hashlib objects don't have the "name" property?
    # @property
    # def name(self):
