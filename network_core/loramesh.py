...
LORAMESHMODI = enum.create_enum(OFF=0, ON=1) # Note: This activates the Lora Mesh mode, the LoRa chip itself should ALWAYS be active
...
class Loramesh:
    ...
    Original source: https://github.com/pycom/pycom-libraries/blob/master/lib/lora_mesh/loramesh.py

    This is a modified version specifically for the Zombie-protocol
    """
    ...
    def __init__(self, lora=None):
        """ Constructor """
        if lora is None:
            raise RuntimeError("No Lora object was passed, LoRa meshing mechanism cannot be setup!")
        self.lora = lora
